...
:: Usage
:: > ridk enable
:: > nanovg_gl3_build_windows.bat  <- %PROGRAMFILES%\CMake\bin\cmake.exe will be used.
:: > nanovg_gl3_build_windows.bat "D:\Program Files\CMake\bin\cmake.exe" <- You can give full path to 'cmake.exe'.
